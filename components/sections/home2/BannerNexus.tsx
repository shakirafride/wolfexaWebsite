...
export default function BannerNexus() {
  return (
    <>
        <section className="main-slider" style={{background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)'}}>
                                ...
                                <div className="col-xl-12">
                                    <div className="main-slider__content">
                                        <div className="main-slider__sub-title-box">
                                            ...
                                            <p className="main-slider__sub-title">Nexus Solutions That Work for You</p>
                                        </div>
                                        <h2 className="main-slider__title">Expert <span style={{color: '#00d4ff'}}>Nexus Solutions</span> <br /> <span style={{color: '#00d4ff'}}>to
                                                Elevate</span> Your <br /> Enterprise
                                        </h2>
                                        <p className="main-slider__text">From strategic Nexus consulting to seamless <br />
                                        ...
                                        <div className="main-slider__btn-and-trustpilot-box">
                                            <div className="main-slider__btn-box">
                                                <Link href="/contact" className="thm-btn" style={{backgroundColor: '#00d4ff', borderColor: '#00d4ff'}}>Get Started<span
